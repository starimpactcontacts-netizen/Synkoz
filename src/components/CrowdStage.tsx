...
const styles = StyleSheet.create({
  ...
  spinBtnWrap: { marginTop: 22, borderRadius: 28, shadowColor: '#c45cff', shadowOpacity: 0.5, shadowRadius: 16, shadowOffset: { width: 0, height: 6 } },
  spinBtn: { paddingHorizontal: 36, paddingVertical: 16, borderRadius: 28 },
